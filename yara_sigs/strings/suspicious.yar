...
rule  System_Tools : SuspiciousStrings
{
    meta:
...
rule  Browsers : SuspiciousStrings
{
    meta:
...
rule  RE_Tools : SuspiciousStrings
{
    meta:
...
rule  Antivirus : SuspiciousStrings
{
    meta:
...
rule  Dropper_Strings : SuspiciousStrings
{
    meta:
...
rule  AutoIT_compiled_script : SuspiciousStrings
{
    meta:
...
rule  WMI_strings : SuspiciousStrings
{
    meta:
...
rule  Base64d_PE : SuspiciousStrings
{
	meta:
...
rule  Misc_Suspicious_Strings : SuspiciousStrings
{
    meta:
